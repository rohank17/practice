...
public class ReverseWordInString {
	...
	public static void main(String[] args) {
		ReverseWordInString inString = new ReverseWordInString();
		inString.reverseWordInMyString("Welcome to BeginnersBook");
		inString.reverseWordInMyString("This is an easy Java Program");
	}
